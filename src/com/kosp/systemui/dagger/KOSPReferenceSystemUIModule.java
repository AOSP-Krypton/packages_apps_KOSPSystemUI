...
import com.kosp.systemui.power.dagger.KOSPPowerModule;
import com.kosp.systemui.qs.dagger.KOSPQSModule;
import com.kosp.systemui.qs.tileimpl.KOSPQSFactoryImpl;
...
@Module(includes = {
        ...
        GestureModule.class,
        MediaModule.class,
        KOSPPowerModule.class,
        KOSPQSModule.class,
        ReferenceScreenshotModule.class,
        StartCentralSurfacesModule.class,
        VolumeModule.class
})
public abstract class KOSPReferenceSystemUIModule {
    ...
    @Binds
    @SysUISingleton
    public abstract QSFactory bindQSFactory(KOSPQSFactoryImpl kospQsFactoryImpl);
