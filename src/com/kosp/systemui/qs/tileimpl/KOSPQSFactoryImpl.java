...
package com.kosp.systemui.qs.tileimpl;
...
import com.kosp.systemui.qs.tiles.DataSwitchTile;
import com.kosp.systemui.qs.tiles.FPSInfoTile;
import com.kosp.systemui.qs.tiles.KOSPBluetoothTile;
import com.kosp.systemui.qs.tiles.KOSPNfcTile;
import com.kosp.systemui.qs.tiles.HeadsUpTile;
import com.kosp.systemui.qs.tiles.LiveDisplayTile;
import com.kosp.systemui.qs.tiles.ReadingModeTile;
import com.kosp.systemui.qs.tiles.RefreshRateTile;
import com.kosp.systemui.qs.tiles.SoundTile;
import com.kosp.systemui.qs.tiles.SyncTile;
...
@SysUISingleton
public class KOSPQSFactoryImpl extends QSFactoryImpl {

    private final Provider<ReadingModeTile> mReadingModeTileProvider;
    private final Provider<RefreshRateTile> mRefreshRateTileProvider;
    private final Provider<CaffeineTile> mCaffeineTileProvider;
    private final Provider<AmbientDisplayTile> mAmbientDisplayTileProvider;
    private final Provider<KOSPNfcTile> mKOSPNfcTileProvider;
    ...
    private final Provider<KOSPBluetoothTile> mKOSPBluetoothTileProvider;

    @Inject
    public KOSPQSFactoryImpl(
        ...
        Provider<KOSPNfcTile> kospNfcTileProvider,
        ...
        Provider<KOSPBluetoothTile> kospBluetoothTileProvider
    ) {
        super(
        ...
        mKOSPNfcTileProvider = kospNfcTileProvider;
        ...
        mKOSPBluetoothTileProvider = kospBluetoothTileProvider;
    }
    ...
    protected QSTileImpl createTileInternal(String tileSpec) {
        switch (tileSpec) {
            ...
            case "kosp_nfc":
                return mKOSPNfcTileProvider.get();
            case "sync":
            ...
            case "bt":
                return mKOSPBluetoothTileProvider.get();
            default:
