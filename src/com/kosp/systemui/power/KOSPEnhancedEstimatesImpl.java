...
package com.kosp.systemui.power;

import static com.android.internal.util.kosp.KOSPUtils.isPackageInstalled;
...
@SysUISingleton
public final class KOSPEnhancedEstimatesImpl implements EnhancedEstimates {

    private static final String TAG = "KOSPEnhancedEstimatesImpl";
    ...
    @Inject
    public KOSPEnhancedEstimatesImpl(
        Context context,
