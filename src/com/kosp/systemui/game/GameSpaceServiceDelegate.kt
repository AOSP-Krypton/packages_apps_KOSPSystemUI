...
package com.kosp.systemui.game
...
class GameSpaceServiceDelegate @Inject constructor(
    ...
    companion object {
        private const val SERVICE_PERMISSION = "com.kosp.permission.MANAGE_GAMESPACE"

        private const val PACKAGE_DELIMITER = ";"

        private const val ACTION_STOP_GAME_MODE = "com.kosp.gamespace.action.STOP_GAME_MODE"
